...
var lives=2;
var gameState="start";
var chooseImg,chooseImg2,intructImage;
...
function preload(){
  ...
  intructImage=loadImage("instructions.png")
...
function setup() {
  ...
  instructions =createSprite(600,230,40,40);
  instructions.addImage(intructImage);
  chooseImg=createSprite(300,500,100,100);
  chooseImg.addImage(choseImg1);
  chooseImg.scale=0.8;
  chooseImg2=createSprite(800,500,100,100);
